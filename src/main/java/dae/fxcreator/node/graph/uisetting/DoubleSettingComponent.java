 ...
 * @author Koen
 */
public class DoubleSettingComponent extends JPanel implements ChangeListener {
     ...
     */
    public void setDoubleSetting(DoubleSetting setting) {
        ...
        if (nrOfFloats <= 4) {
            for (int i = 0; i < nrOfFloats; i++) {
                ...
                model.setValue(setting.getDouble(i));
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        Double value = (Double) source.getModel().getValue();
        setting.setDouble(index, value);
