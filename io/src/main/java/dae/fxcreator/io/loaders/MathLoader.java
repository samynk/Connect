...
import dae.fxcreator.node.graphmath.MultipleMathElement;
...
public class MathLoader extends XMLHandler {
    ...
    private File file;
    private Stack<MathElement> current = new Stack<>();
    private ArrayList<MathFormula> formulas = new ArrayList<>();
