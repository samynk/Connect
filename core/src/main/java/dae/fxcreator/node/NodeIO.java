...
public abstract class NodeIO {
    ...
    public void setName(String name) {
        ...
        if (!this.name.equals(name)) {
            ...
            if (this.parent != null) {
                if (isInput()) {
                    parent.remapInputName(oldName, (NodeInput) this);
                } else {
                    parent.remapOutputName(oldName, (NodeOutput) this);
                }
            }
        }
    }
    ...
    public void setSemantic(String semantic) {
        if (!semantic.equals(this.semantic.getValue())) {
            ...
            this.semantic.setValue(semantic);
            if (isInput()) {
                parent.remapInputSemantic(oldValue, (NodeInput) this);
            } else {
                parent.remapOutputSemantic(oldValue, (NodeOutput) this);
            }
        }
    }
