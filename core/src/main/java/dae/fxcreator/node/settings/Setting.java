...
public abstract class Setting implements Cloneable, SymbolListener {
     ...
     */
    private final ArrayList<String> globalSymbols = new ArrayList<>();
    /**
    ...
    /**
     * Notifies the node object that the setting was changed. checks if the node
     * != null before calling the node method.
     */
     ...
     *
     * @param node the node that is bound to this setting.
     */
     ...
     * @throws java.lang.CloneNotSupportedException thrown if the object does
     * not support cloning.
     */
    @Override
    ...
    /**
     * Checks if the value of the setting is written as an attribute (with the
     * name value) or as a cdata section inside a value element. (default is to
     ...
     *
     * @return the visualized state (true if the setting should be visualized in
     * the node).
     */
    ...
    /**
     * Set the state of the visualization. If set to true , this setting will be
     * visualized in the node. The default is false.
     *
     * @param visualized true if the visual should be shown, false otherwise.
     */
    ...
    /**
     * Notifies that a symbol was removed from the project. A symbol can be a
     * ShaderStage, Struct, Techniqu or Pass.
     *
    ...
    /**
     * Checks if this setting is a default value. Writers can use this to skip
     ...
     *
     * @param defaultValue pass true if this setting is a default value, false
     * otheriwse.
     */
