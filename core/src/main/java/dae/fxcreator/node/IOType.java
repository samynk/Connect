 ...
 */
public class IOType implements Key{
     ...
     */
    public IOType(String type, int order) {
     ...
     */
    public IOType(String type, int order, boolean valueType) {
     ...
     */
    public IOType(String type, int order, boolean valueType, String icon) {
        this.type = type;
        this.order = order;
    ...
    /**
     * Returns the unique key of this Shadertype.
     * @return the key of this shadertype.
     */
    @Override
