...
public class NodeOutput extends NodeIO implements TypedNode{
     ...
     */
    private final ArrayList<NodeInput> nodes = new ArrayList<>();
    /**
     ...
     */
    public NodeOutput(IONode parent, String name, String semantic, String type, String typeRule) {
     ...
     * be applied on the inputs.
     */
    public NodeOutput(IONode parent, String name, String semantic, IOType type, String typeRule) {
    ...
    public void setIOType(IOType type) {
        if (!type.equals(getIOType())) {
             ...
             */
            ArrayList<NodeInput> inputs = (ArrayList<NodeInput>)this.nodes.clone();
     ...
     */
    public void addInput(NodeInput input) {
    ...
    public boolean isOutputConnectedTo(IONode node) {
        for (NodeInput input : this.nodes) {
    ...
    public void removeAllInputs() {
        ArrayList<NodeInput> inputsClone = (ArrayList) this.nodes.clone();
        for (NodeInput input : inputsClone) {
